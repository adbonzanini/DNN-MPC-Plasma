...
path_do_mpc = '/users/adbonzanini/Box Sync/Berkeley/Research/Explicit MPC Paper/DNN-MPC-Plasma/'
print path_do_mpc
...
while (configuration_1.simulator.t0_sim + configuration_1.simulator.t_step_simulator < configuration_1.optimizer.t_end):
    ...
    print('\n--------------------------------------------------')
    print('Nominal Prediction =', xplusNominal)
    print('Optimal Trajectory = ', xopt[-L:,:].T)
