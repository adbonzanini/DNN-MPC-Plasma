...
# # Metal model (plant model)
# modelMatM = sio.loadmat('/users/adbonzanini/box sync/berkeley/research/gaussian process/MIMO GP State Feedback Substrates/Supporting Data Files/MIMOmodelMetal')
# Areal = modelMatM['A']
# Breal = modelMatM['B']
